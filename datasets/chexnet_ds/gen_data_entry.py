...
parser.add_argument('output_dir', metavar='output_dir', type=str, help='the output directory')
parser.add_argument('output_size', metavar='output_size', type=int, help='output_size')

args = parser.parse_args()
output_dir = str(args.output_dir)
output_size = args.output_size
imgdirs = ['fneckfx', 'intertrocfx', 'normalpxr']
diag_str = ['Femoral_Neck_FX', 'Intertrochanteric_FX', 'Normal']
...
with open('image_data_entry.csv', 'w', newline='') as csvfile:
    ...
    for i, v in enumerate(imgdirs):
        print(f"Processing {diag_str[i]}: {v}")
